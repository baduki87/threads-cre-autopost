...
말투는 계정 주인이 실제로 쓴 답글 30건에서 뽑았습니다. 그대로 따라 하세요.

```
둘다 넘 좋죠!          아 그렇군요!         감사합니다!!!
오 그런가요 ㅎㅎ        동의합니다 ㅎㅎ       여기서 살고 싶네요~!
상세한 부분 짚어주셔서 감사합니다!!
엄마 손에 이끌리는 아이들도 많더라구요~
```

- **한 문장.** 길어야 두 문장
- 존댓말이되 **격식을 뺍니다.** `~죠!` `~네요!` `~구요!` `~더라구요~`
- **느낌표를 기본으로 붙입니다.** 거의 모든 답글이 `!` 로 끝납니다
- 물결(`~`), `ㅎㅎ`, `^^` 를 가끔 씁니다. 남발하지는 마세요
- `아` `오` `앗` 같은 감탄사로 열어도 좋습니다
- **`~합니다` 로 딱딱하게 끝내지 마세요.** 본문은 그래도 되지만 답글에선 차갑습니다
- 상대가 반말로 달아도 존댓말로 답합니다
