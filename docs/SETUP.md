...
하루 3건이 나갑니다. **승인을 안 하셔도 3건 다 나갑니다.**

다만 회원님이 노션에 **메모를 남기신 날**은 그 글이 밤 9시로 가고,
그때는 승인을 받습니다. 회원님 판단이 담긴 글이라 확인 없이 내보내지 않습니다.
승인을 안 하시면 그날 밤 9시 글은 안 나갑니다.
...
| — | (회원님) | 노션에서 확인 → `승인` |
| 21:00 | `밤 9시 발행` | 승인한 게 있으면 그걸, 없으면 뉴스 글을 자동으로 |
